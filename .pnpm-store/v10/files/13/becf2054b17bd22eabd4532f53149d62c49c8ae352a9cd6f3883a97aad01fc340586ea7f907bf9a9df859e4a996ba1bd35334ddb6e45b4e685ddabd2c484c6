...
exports.LandingZone = exports.getControlsOutput = exports.getControls = exports.ControlTowerControl = exports.Baseline = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.Baseline = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "aws:controltower/baseline:Baseline":
                return new exports.Baseline(name, undefined, { urn });
