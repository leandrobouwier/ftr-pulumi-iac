...
exports.SessionLoggerAssociation = void 0;
...
class SessionLoggerAssociation extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new SessionLoggerAssociation(name, state, { ...opts, id: id });
    }
    /**
...
exports.SessionLoggerAssociation = SessionLoggerAssociation;
/** @internal */
SessionLoggerAssociation.__pulumiType = 'aws:workspacesweb/sessionLoggerAssociation:SessionLoggerAssociation';
